    ...
    public function run()
    {
        ...
        DB::table('email_templates')->insert([
        	...
        	[
	            ...
	            'description' => "<%video_name%> video uploaded in <%category_name%>, don't miss the video from {{Setting::get('site_name')}}. Click here to view video <%video_id%>",
	            'status'=>1,
	            'created_at'=>date('Y-m-d H:i:s'),
	            'updated_at'=>date('Y-m-d H:i:s')
        	],
        	[
	            ...
	            'subject' => "<%video_name%> in <%site_name%>",
	            'description' => "<%video_name%> video uploaded in <%category_name%>, don't miss the video from <%site_name%>. Click here to view video <%video_id%>",
	            'status'=>1,
	            'created_at'=>date('Y-m-d H:i:s'),
	            'updated_at'=>date('Y-m-d H:i:s')
        	]
