...
<head>
    ...
    <style type="text/css">
        ...
        @media only screen and (max-width: 480px) {
            ...
            .mcnCartContainer,.mcnCaptionTopContent,.mcnRecContentContainer,.mcnCaptionBottomContent,.mcnTextContentContainer,
            .mcnBoxedTextContentContainer,.mcnImageGroupContentContainer,.mcnCaptionLeftTextContentContainer,.mcnCaptionRightTextContentContainer,
            .mcnCaptionLeftImageContentContainer,].mcnCaptionRightImageContentContainer,.mcnImageCardLeftTextContentContainer,
            .mcnImageCardRightTextContentContainer,.mcnImageCardLeftImageContentContainer,.mcnImageCardRightImageContentContainer {
                max-width: 100% !important;
                width: 100% !important;
            }
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="mcnTextContent" style="padding: 0px 18px 9px; font-size: 19px; " valign="top">
                                                                                    ...
                                                                                    <span style="text-align: center;">
                                                                                        ...
                                                                                        A friendly remainder that your subscription at {{Setting::get('site_name')}} is expired.

                                                                                        <br>
                                                                                        <br>

                                                                                        To renew or update your subscription <a href="{{Setting::get('ANGULAR_SITE_URL')}}/signin">Log in to your profile </a> and follow suggested actions.
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td class="mcnButtonContent" style=" font-size: 18px; font-family:'Lato', 'Helvetica Neue', Helvetica, Arial, sans-serif;padding: 10px 25px;" valign="middle" align="center">
                                                                                    <a class="mcnButton " title="Visit Video" href="{{Setting::get('ANGULAR_SITE_URL')}}" target="_self" style="letter-spacing: 1px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Visit Webiste</a>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
