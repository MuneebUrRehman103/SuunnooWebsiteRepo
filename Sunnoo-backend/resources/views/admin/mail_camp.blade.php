                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="radio" name="to" id = "custom_user" value="{{CUSTOM_USERS}}">&nbsp; {{tr('custom_user')}}
                                </label>
                                <br><br>
                                <!-- Users -->
                            ...
                            <div class="col-sm-10 pull-right" id="custom" style="display: none">
                                ...
                                <input type="text" max="255" name="custom_user" class="form-control" placeholder="{{tr('custom_user')}}">
                            </div>
