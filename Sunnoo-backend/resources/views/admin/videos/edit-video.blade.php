                        ...
                        <div class="">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="publish_time" placeholder="{{tr('select_publish_time')}}" class="form-control pull-right" id="datepicker" value="{{$video->publish_time}}">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="genre_id">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="genre" name="genre_id" class="select2" @if(!$video->is_series) disabled @endif>
                                            @if($video->genre_id)
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <label style="margin-top:10px" >
                                                <input type="radio"  name="video_upload_type" value="1" class="flat-red" @if($video->video_upload_type == 1) checked @endif>
                                                {{tr('s3')}}
                                            </label>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <label>{{tr('send_notification')}}</label>&nbsp;&nbsp;<input type="checkbox" name="send_notification" class="flat-red" value="1" />
