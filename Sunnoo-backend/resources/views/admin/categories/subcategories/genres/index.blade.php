            								...
            								<li class="dropup">
								                ...
								                <ul class="dropdown-menu">
								                	...
								                	@endif
								                  	...
								                  	@if($value->is_approved)
								                  		<li role="presentation"><a role="menuitem" tabindex="-1" href="{{route('admin.genre.approve' , array('id' => $value->genre_id , 'status' =>0))}}" onclick="return confirm('{{$decline}}')">{{tr('decline')}}</a></li>
								                  	@else
								                  		<li role="presentation"><a role="menuitem" tabindex="-1" href="{{route('admin.genre.approve' , array('id' => $value->genre_id , 'status' => 1))}}" onclick="return confirm('{{$approve}}')">{{tr('approve')}}</a></li>
								                  	@endif
								                  	...
								                  	<li role="presentation">
								                  		...
								                  		@if(Setting::get('admin_delete_control'))
									                  	 ...
									                  	 @else
								                  			...
								                  			<a role="menuitem" onclick="return confirm('{{$delete}}')" tabindex="-1" href="{{route('admin.delete.genre' , array('id' => $value->genre_id))}}">{{tr('delete')}}</a>
								                  		@endif
