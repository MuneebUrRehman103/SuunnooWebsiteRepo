                            ...
                            <div class="box-body">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <label for="streaming_url">{{tr('socket_url')}}</label>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <label for="streaming_url">{{tr('admin_url')}}</label>

                                        <input type="text" value="{{$result['SOCKET_URL']}}" class="form-control" name="SOCKET_URL" id="SOCKET_URL" placeholder="{{tr('socket_url')}}">
                                    </div> 
                                </div>
                            ...
                            <div class="box-body"> 
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <label for="custom_user">{{tr('custom_user')}}</label>
                                            <input type="text" class="form-control" value="{{ Setting::get('custom_users_count')}}" name=" custom_users_count" id="custom_users_count" placeholder="{{tr('custom_user_count')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <label for="upload_max_size">{{tr('email_notification')}}</label>
                                            <div class="clearfix"></div>
