                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="compress">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <div>
                                        <input type="radio" name="compress_video" value="1" class="flat-red"> <label>{{tr('yes')}}</label> &nbsp;&nbsp;
                                        <input type="radio" name="compress_video" value="0" class="flat-red" checked> <label>{{tr('no')}}</label>
                                    </div>
                                </div>
                            </div>
