                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="compress">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <div>
                                        <input type="radio" name="compress_video" class="flat-red" value="1"> <label>{{tr('yes')}}</label> &nbsp;&nbsp;
                                        <input type="radio" name="compress_video" class="flat-red" value="0" checked> <label>{{tr('no')}}</label>
                                    </div>
                                </div>
                            </div>
