                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([{
                                files: [
                                'lazy_notify',
                                'https://cdnjs.cloudflare.com/ajax/libs/video.js/7.0.3/video-js.min.css',
                                'assets/videojs/css/videojs-bug.css',
                                'assets/videojs/css/videojs-share.css',
                                'assets/videojs/css/videojs-seek-buttons.css',
                                'assets/videojs/css/videojs-hls-quality-selector.css',
                                'assets/videojs/css/videojs.suggestedVideoEndcap.css',
                                "https://s3.amazonaws.com/s3bubble.videojs/cdn/videojs-s3bubble-meta-overlay.css",
                                'assets/videojs/css/videojs-custom-theme.css',
                                'assets/videojs/css/videojs-css.css',
                                'http://vjs.zencdn.net/ie8/1.1.2/videojs-ie8.min.js',
                                'https://cdnjs.cloudflare.com/ajax/libs/video.js/7.0.3/video.min.js',
                                'https://cdnjs.cloudflare.com/ajax/libs/videojs-contrib-hls/5.14.1/videojs-contrib-hls.min.js',
                                'assets/videojs/js/videojs-share.js',
                                'assets/videojs/js/videojs-bug.min.js',
                                'assets/videojs/js/videojs-seek-buttons.js',
                                'assets/videojs/js/videojs.suggestedVideoEndcap.js',
                                'assets/videojs/js/videojs-hls-quality-selector.min.js',
                                'assets/videojs/js/videojs-contrib-quality-levels.min.js',
                                'https://s3.amazonaws.com/s3bubble.videojs/cdn/videojs-s3bubble-meta-overlay.min.js',
